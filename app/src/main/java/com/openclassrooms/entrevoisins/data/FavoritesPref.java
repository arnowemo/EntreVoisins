package com.openclassrooms.entrevoisins.data;
...
public class FavoritesPref {
    ...
    public static void writeFavList(Context context, ArrayList <Integer > list){
        Gson gson = new Gson();
    ...
    public static  ArrayList<Integer> readListFav ( Context context){
